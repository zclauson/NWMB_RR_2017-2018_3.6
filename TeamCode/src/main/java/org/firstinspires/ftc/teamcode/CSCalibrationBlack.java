 ...
 */
@TeleOp(name = "CSCalibrationBlack",group = "CSCalibrationBlack")
public class CSCalibrationBlack extends OpMode {
    ...
    public void loop() {
        ...
        mo.color1.writeCommand(ModernRoboticsI2cColorSensor.Command.CALIBRATE_BLACK);
